...
const sentencesMasterSaveBtn = document.getElementById("sentences-master-save-btn");
...
if (sentencesMasterSaveBtn) sentencesMasterSaveBtn.addEventListener("click", saveCurrentSentenceListItem);
