...
const QA_CONTENT_SETS = [
  createQaContentSet({
    ...
    rounds: [
      ...
      {
        id: "K",
        mnQuestion: "Энэ хэн бэ ?",
        mnAnswer: "Энэ бол миний ээж.",
        enQuestion: "Who is this ?",
        enAnswer: "This is my mother .",
        wordBankTokens: ["Who", "is", "this", "?", "This", "is", "my", "mother", "."],
      },
      {
        id: "L",
        mnQuestion: "Өглөөний цайнд юу байна вэ ?",
        mnAnswer: "Талх, өндөг байна.",
        enQuestion: "What is for breakfast ?",
        enAnswer: "Bread and eggs .",
        wordBankTokens: ["What", "is", "for", "breakfast", "?", "Bread", "and", "eggs", "."],
      },
      {
        id: "M",
        mnQuestion: "Хэдэн цаг болж байна вэ ?",
        mnAnswer: "Долоон цаг болж байна.",
        enQuestion: "What time is it ?",
        enAnswer: "It is seven o'clock .",
        wordBankTokens: ["What", "time", "is", "it", "?", "It", "is", "seven", "o'clock", "."],
      },
      {
        id: "N",
        mnQuestion: "Та хаана ажилладаг вэ ?",
        mnAnswer: "Би дэлгүүрт ажилладаг.",
        enQuestion: "Where do you work ?",
        enAnswer: "I work in a shop .",
        wordBankTokens: ["Where", "do", "you", "work", "?", "I", "work", "in", "a", "shop", "."],
      },
      {
        id: "O",
        mnQuestion: "Би хаана зүүн тийш эргэх вэ ?",
        mnAnswer: "Банк дээр зүүн тийш эргэ.",
        enQuestion: "Where do I turn left ?",
        enAnswer: "Turn left at the bank .",
        wordBankTokens: ["Where", "do", "I", "turn", "left", "?", "Turn", "left", "at", "the", "bank", "."],
      },
      {
        id: "P",
        mnQuestion: "Би гэртээ яаж харих вэ ?",
        mnAnswer: "Чигээрээ яваад баруун тийш эргэ.",
        enQuestion: "How do I get home ?",
        enAnswer: "Go straight and turn right .",
        wordBankTokens: ["How", "do", "I", "get", "home", "?", "Go", "straight", "and", "turn", "right", "."],
      },
    ],
