...
export const BOARD_GAME_CONFIG = {
  levels: {
    world1: {
      totalTiles: 26,
      chapters: [
        { id: "ch1", index: 1, title: "I бүлэг: Аяллын эхлэл", story: "Та хилийн боомт дээр ирлээ.", startTile: 1, endTile: 5 },
        { id: "ch2", index: 2, title: "II бүлэг: Хотын төв", story: "Та хэл сурах шинэ орчинд орлоо.", startTile: 6, endTile: 10 },
        { id: "ch3", index: 3, title: "III бүлэг: Захын буудал", story: "Одоо та аяллын хурдыг мэдэрч эхэллээ.", startTile: 11, endTile: 15 },
        { id: "ch4", index: 4, title: "IV бүлэг: Соёлын өртөө", story: "Яриа улам гүнзгий болж байна.", startTile: 16, endTile: 20 },
        { id: "ch5", index: 5, title: "V бүлэг: Оргил хүрэх зам", story: "Та финалын сорилтод ойртож байна.", startTile: 21, endTile: 26 },
      ],
    },
  },
};
